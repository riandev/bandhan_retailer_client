...
const LeadGenerate = () => {
  ...
  const generateInitial = () => {
    fetch("http://192.168.10.14:6011/initialLead?initDate=" + initialDate)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setInitialLeads(
  ...
  const updateInitialLeads = () => {
    fetch("http://192.168.10.14:6011/updateInitialLead", {
      method: "PATCH",
  ...
  const regenerateLeads = () => {
    fetch("http://192.168.10.14:6011/regenerate?regenDate=" + regenDate)
      .then((res) => res.json())
      .then((data) => {
        setRegenerate(
          data
  ...
  const regenerateUpdate = () => {
    fetch("http://192.168.10.14:6011/regenerateUpdate", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
